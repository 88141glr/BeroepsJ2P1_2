      ...
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <?php
            if (isset($_SESSION['logged_in']) && $_SESSION['logged_in']) {
                ...
                echo '<li><a class="dropdown-item" href="adminprojects.php">Remove Cards</a></li>';
                echo '<li><a class="dropdown-item" href="adminupload.php">Upload Cards</a></li>';
                echo '<li><hr class="dropdown-divider"></li>';
                echo ' <li><a class="dropdown-item" href="Login/logout.php">Sign out</a></li>';
                echo '</ul>';
            } else {
...
if (isset($_GET['delete_status']) && $_GET['delete_status'] === 'success') {
    echo '<p style="color: green;">Card deleted successfully.</p>';
}

// Check if a project ID is provided via GET request
if (isset($_GET['cards_id'])) {
...
$sql = "SELECT ID, Name, Description, image_path FROM Cards";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<td><a href="adminprojects.php?cards_id=' . $row['ID'] . '">Delete</a></td>';
        echo '</tr>';
    }
    echo '</table>';
} else {
